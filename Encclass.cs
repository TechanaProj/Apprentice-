...
namespace IFFCO.Web
{
    public static class Encclass
    {
        ...
        //        {
        //            // string str = "insert into adm_report_log (MODULENAME, REPORTNAME, RUNTIME)Values('" + modulename + "','" + reportname + "',TO_DATE('" + runtime + "', 'MM/DD/YYYY HH24:MI:SS'))";
        //            string str = "insert into adm_report_log (MODULENAME, REPORTNAME, RUNTIME, R_NAME,REPORT_PARAMETERS,PERSONAL_NO,FULLCLIENTIP,CLIENTIP)Values('" + modulename + "','" + reportname + "',sysdate,'" + name + "','" + QueryString + "','" + personalNo + "','" + fullClientIp + "','" + clientIp + "' )";
        ...
        //            using (OracleConnection con = new OracleConnection(connstring))
        //            {
        //                // string str = "insert into adm_report_log (MODULENAME, REPORTNAME) Values ('" + modulename + "','" + reportname + "')";
        //                string str = "insert into adm_report_log (MODULENAME, REPORTNAME, R_NAME,PERSONAL_NO,FULLCLIENTIP,CLIENTIP) Values ('" + modulename + "','" + reportname + "','" + name + "','" + personalNo + "','" + fullClientIp + "','" + clientIp + "')";
